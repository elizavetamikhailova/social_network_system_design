...
- Avg requests per day: создание постов - 1/день, загрузка фото к посту 5 фото/день, реакции (комментарий + оценка) - 10/день, подписка - 1-3 новые подписки/день, поиск - 7 поисков/день, просмотр полной информации в посте - 21 пост/день, загрузка ленты 30 загрузок/день (включая пагинацию)
...
>> - latitude 8 byte
>> - longtitude 8 byte
- RPS(пост) = dau * avg_requests_per_day_by_user / 86 400 = 10 000 000 * 1 / 86 400 = 115
- Traffic(пост) = rps * avg_request_size = 115 * 2 kb = 15 002 = 230 kb
- RPS(фото) = dau * avg_requests_per_day_by_user / 86 400 = 10 000 000 * 5 / 86 400 = 578
- Traffic(загрузка фото) = 578 * 3000 kb(примерный вес фото из поста после сжатия) = 1.7 GB
...
>> - rate 8 byte
- RPS = 10 000 000 * 21 / 86 400 = 2430
- Traffic = 2430 * 11 kb = 27 mb
- Connections = dau * 0.1 = 1 000 000   
### Просмотр ленты
> Posts
>
